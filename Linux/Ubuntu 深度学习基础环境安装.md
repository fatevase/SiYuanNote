...
安装 conda 可以方便的对我们系统中的 python 不同环境进行操作,避免因为 python 版本等问题导致系统环境混乱.
...
根据提示安装好 conda 后，检查`~/.bashrc` 中有无conda环境，
{: id="20210120224135-v3v6c33"}

没有则需要手动把 conda 加入环境变量中即可
{: id="20210128091812-52scpmw"}
...
{: id="20210128113543-d8kefop"}

> Conda 里也可以配置 cudatoolkit
> {: id="20210123025337-5q7ws6i"}
{: id="20210123025335-6t16stl"}

{: id="20210128113543-q9ui827"}

{: id="20210128113543-v7iuwzf"}
...
{: id="20210128113543-ltbheuf"}

{: id="20210128113543-q7nrfxb"}
